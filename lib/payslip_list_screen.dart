...
class _PayslipListScreenState extends State<PayslipListScreen> {
  ...
  Future<void> _startDownloadProcess(PayslipSummary summary, int index, {required bool isQuickDownload}) async {
    ...
    return Scaffold(
      ...
      body: Consumer<PayslipProvider>(
        builder: (context, provider, child) {
          if (provider.isLoading && provider.summaries.isEmpty) return const Center(child: CircularProgressIndicator());
